...
const tasks_1 = require("../controllers/tasks/tasks");
const collections_1 = require("../controllers/collections/collections");
const mongo_1 = require("./mongo");
const errorResponse_1 = require("../middlewares/errorResponse");
const successResponse_1 = require("../middlewares/successResponse");
exports.app = new Koa();
mongo_1.default(exports.app);
exports.app.use(errorResponse_1.default());
exports.app.use(successResponse_1.default());
...
exports.app.use(collections_1.collectionsRouter.routes()).use(tasks_1.tasksRouter.allowedMethods());
